...
public class ObjectNode
{
   ...
   **/
   ...
   public String toString() {
	   ...
	   sb.append(data);
	   ObjectNode copylink = link;
	   
	   while (copylink != null) {
		   sb.append(copylink.data);
		   copylink = copylink.link;
	   }
   ...
   public static void main(String args[]) {
	   ObjectNode headNode = new ObjectNode('A', null);
	   ObjectNode copynode = headNode;
	   
	   char ch;
	   for (ch='B';ch <='Z';ch++) {
		   copynode.addNodeAfter(ch);
		   copynode = copynode.link;
	   }
	   
	   System.out.println(headNode.toString());
	   System.out.println("Number of nodes = "+listLength(headNode));
	   System.out.println("Number of nodes = "+listLength_rec(headNode));
	   
	   ObjectNode k = listCopy(headNode);
	   System.out.println(k.toString());
	   System.out.println("Number of nodes in r = "+listLength(k));
	   System.out.println("Number of nodes in r = "+listLength_rec(k));

	   ObjectNode k2 = listCopy(headNode);
	   System.out.println(k2.toString());
	   System.out.println("Number of nodes in r2 = "+listLength(k2));
	   System.out.println("Number of nodes in r2 = "+listLength_rec(k2));
